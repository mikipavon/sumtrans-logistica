...
const MAINTENANCE_TYPES = [
    ...
    { value: 'Filtros',   label: 'Filtros',                 icon: Wrench,       color: 'text-blue-500 bg-blue-50 border-blue-200' },
    { value: 'Frenos',    label: 'Frenos / Pastillas',      icon: Wrench,       color: 'text-orange-500 bg-orange-50 border-orange-200' },
