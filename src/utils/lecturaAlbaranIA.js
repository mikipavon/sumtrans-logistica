...
// +34, "PAGADOS" en vez de "Pagado", null donde se esperaba texto… Aquí se
// deja todo con la forma que usan los campos de ImportarAlbaranesAgencia, y
// lo que no tenga sentido se queda vacío para que la oficina lo vea y lo rellene.
//
...
function porte(v) {
    ...
    if (/pagad/.test(s)) return 'Pagado';
    if (/debid/.test(s)) return 'Debido';
    return '';
}
