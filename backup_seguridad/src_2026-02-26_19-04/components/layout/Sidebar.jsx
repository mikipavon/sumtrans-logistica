import { LayoutDashboard, Truck, Package, Settings, LogOut, Menu, Users, Map, Database, Tag, FileText, AlertTriangle, UserCheck, Wallet, Calculator } from 'lucide-react';
    ...
    const sections = [
        {
            ...
            items: [
                ...
                { id: 'quotes', icon: Calculator, label: 'Cotización' },
            ]
        },
        {
